...
num_Q = 49 # number of steps along each direction in the positive quadrant
Q_range = [0,4, 0,4] # range of Q in the positive quadrant

extent = [-4,4,-4,4] # extent of unfolded Q
...
vlims = [0,0.000001] # colormap scale
fig,ax=plt.subplots(figsize=(7,6))
