...
im = ax[1].imshow(vn_sqw[:,:num_e].T,origin='lower',aspect='auto',interpolation=interp,cmap=cmap,
                 vmin=vmin,vmax=vmax,extent=extent)
...
ax[0].annotate(r'pristine',xy=(0.05,0.9),xycoords='axes fraction',fontsize='x-large',color=c)
ax[1].annotate('10\% O\nvacancies',xy=(0.02,0.8),
                           xycoords='axes fraction',fontsize='x-large',color=c)
