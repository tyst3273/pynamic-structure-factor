...
ax[0].annotate(r'pristine',xy=(0.05,0.05),xycoords='axes fraction',fontsize='x-large',color=c)
ax[1].annotate('10\% Ge\nsubsitutions',xy=(0.02,0.05),
                           xycoords='axes fraction',fontsize='x-large',color=c)

# fig_name = f'H{hkl[0]:3.2f}K{hkl[1]:3.2f}L{hkl[2]:3.2f}_perp_s{ss:3.2f}_fits.pdf'
