...
fig_name = 'mapi_phonons_neutrons_vs_xrays.pdf'
...
vmax = 7.5e-3
im = ax[1].imshow(dn_sqw[:,:num_e].T,origin='lower',aspect='auto',interpolation=interp,cmap=cmap,
                 vmin=vmin,vmax=vmax,extent=extent)
...
ax[0].annotate(r'deuterated',xy=(0.025,0.9),xycoords='axes fraction',fontsize='large',color=c)
ax[1].annotate('xrays',xy=(0.025,0.9),
