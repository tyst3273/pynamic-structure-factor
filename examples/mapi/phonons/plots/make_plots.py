...
fig_name = 'mapi_phonons_neutrons.pdf'
...
ax[0].annotate(r'protonated',xy=(0.025,0.9),xycoords='axes fraction',fontsize='large',color=c)
ax[1].annotate('deuterated',xy=(0.025,0.9),
