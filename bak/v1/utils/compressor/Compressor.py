...
class compressor:
    ...
    contains:
    pos_data = [num_time_steps, num_atoms, [x,y,z]] = 3 axes
    time_step = [num_time_steps] = 1 axis
    atom_types = [num_atoms] = 1 axis 
    box_bounds = [num_steps, [xlo, xhi, ylo, yhi, zlo, zhi]] = 2 axes
