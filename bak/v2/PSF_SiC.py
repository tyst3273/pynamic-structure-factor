...
md_args = {'traj_file':'lammps/SiC/pos.dat',
           'dt':0.5e-15,
           'stride':16,
           'total_steps':2**19,
           'num_atoms':4096,
...
io = FileIO.io(params,calc,f_name='sqe_new_1.dat')

sqw_args['Qmin'] = [2,2,0]
sqw_args['Qmax'] = [6,6,0]
params = Parameters.params(**md_args,**sqw_args)
calc = Calculator.calc(params)
io = FileIO.io(params,calc,f_name='sqe_new_2.dat')

sqw_args['Qmin'] = [2,2,2]
sqw_args['Qmax'] = [6,6,6]
params = Parameters.params(**md_args,**sqw_args)
calc = Calculator.calc(params)
io = FileIO.io(params,calc,f_name='sqe_new_3.dat')

sqw_args['Qmin'] = [2,0,1]
sqw_args['Qmax'] = [6,0,1]
params = Parameters.params(**md_args,**sqw_args)
calc = Calculator.calc(params)
io = FileIO.io(params,calc,f_name='sqe_new_4.dat')

sqw_args['Qmin'] = [2,1,1]
sqw_args['Qmax'] = [6,1,1]
params = Parameters.params(**md_args,**sqw_args)
calc = Calculator.calc(params)
io = FileIO.io(params,calc,f_name='sqe_new_5.dat')

sqw_args['Qmin'] = [2,0.25,0]
sqw_args['Qmax'] = [6,0.25,0]
params = Parameters.params(**md_args,**sqw_args)
calc = Calculator.calc(params)
io = FileIO.io(params,calc,f_name='sqe_new_6.dat')

sqw_args['Qmin'] = [2,0.25,0.25]
sqw_args['Qmax'] = [6,0.25,0.25]
params = Parameters.params(**md_args,**sqw_args)
calc = Calculator.calc(params)
io = FileIO.io(params,calc,f_name='sqe_new_7.dat')
