...
class params:
    ...
    def __init__(self,traj_file='lammps/pos.dat',unwrap_pos=False,dt=1e-15,stride=32,
            total_steps=2**21,num_atoms=512,num_types=2,b={'1':4.1491e-5},supercell=[16,2,2],
