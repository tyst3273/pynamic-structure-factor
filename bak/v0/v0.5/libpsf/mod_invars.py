...
class input_variables:
    ...
    def __init__(self):
        ...
        # number of processes to use in multiprocessing. if not given, it defaults to using 
        # all available processors. set to 1 to only use 1 process.
    ...
    def parse_input(self,input_file):
        ...
        self.num_processes = self._parse_int('num_processes',self.num_processes)
